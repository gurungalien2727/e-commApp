...
$uid=$_SESSION['userid'];
 ...
 echo '<h1 style="text-align:center">E-Comm Website';
...
<div class="banner" style="height:200px;width:300px;background-color:#; float:right">
</div>
<div class="container">
...
<?php
   ...
   if($row['category']=="Laptop" || $row['category']=="Monitor" ||  $row['category']=="CellPhone" ){
